...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 07:35 AM
...
INSERT INTO `actor` (`Person_ID`, `Person_Name`, `Birth_year`, `No_of_Films`, `No_of_Awards`) VALUES
...
INSERT INTO `director` (`Person_ID`, `Person_Name`, `Birth_year`, `No_of_Films`, `No_of_Awards`) VALUES
(1, 'Zahir Raihan', 1935, 5, 10),
(2, 'Rajkumar Hirani', 1962, 5, 9),
(3, 'Saytajit Ray', 1921, 45, 55),
(4, 'Anjun Dutt', 1953, 23, 17),
...
INSERT INTO `movie` (`Movie_ID`, `Movie_name`, `Genre`, `Release_Year`, `IMDb_Rating`, `Person_ID`) VALUES
(1, 'Pather Panchali', 'Drama', 1955, 8.5, 3),
(2, 'Noukadubi', 'Drama', 1955, 7.6, 5),
...
ALTER TABLE `movie_character_relationship`
  ...
  ADD CONSTRAINT `movie_character_relationship_ibfk_2` FOREIGN KEY (`Character_ID`) REFERENCES `movie_characters` (`Character_ID`);
COMMIT;
