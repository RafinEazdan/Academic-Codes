...
int main (){
   ...
   if((l==a)&&(o<b)){
    cout<<"For all X and For some Y the value is: TRUE\n";
   }
   else{
        cout<<"For all X and For some Y the value is: FALSE\n";

   }
   if((l<a)&&(o==b)){
        cout<<"For some X and For all Y the value is: TRUE\n";

   }
   else{
        cout<<"For some X and For all Y the value is: FALSE\n";
